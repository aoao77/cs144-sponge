...
//! \param[in] limit is the maximum number of bytes to read; fewer bytes may be
//! returned \param[out] str is the string to be read
...
//! \param[in] limit is the maximum number of bytes to read; fewer bytes may be
//! returned \returns a vector of bytes read
